(function() {
    ...
    QUnit.test("authenticationHeaderCorrectlyGenerated", function authenticationHeaderCorrectlyGenerated(assert) {
    ...
    QUnit.test("xAuthAuthenticationHeaderCorrectlyGenerated", function xAuthAuthenticationHeaderCorrectlyGenerated(assert) {
    ...
    QUnit.test("signatureGeneratedCorrectly", function signatureGeneratedCorrectly(assert) {
        var url = "https://api.twitter.com/1/statuses/update.json";
        var request = new Codevoid.OAuth.OAuthRequest(fakeClientInfo, url);
        request._nonce = "kYjzVBB8Y0ZFabxSWbWovY3uYSQ2pTgmZeNu2VS4cg";
        request._timestamp = 1318622958;
    ...
    QUnit.test("canVerifyTwitterCredentials", function canVerifyTwitterCredentials(assert) {
    ...
    QUnit.test("canPostStatusToTwitter", function canPostStatusToTwitter(assert) {
