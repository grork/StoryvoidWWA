namespace Codevoid.Storyvoid {
    ...
    export class InstapaperSync extends Utilities.EventSource {
        ...
        private _raiseStatusChanged(payload: ISyncStatusUpdate) {
        ...
        /// </summary>
        private _addFolderPendingEdit(edit, db: InstapaperDB) {
        ...
        /// Has mirror method for removing a folder.
        /// </summary>
        private _removeFolderPendingEdit(edit) {
        ...
        private _syncFolders(db, cancellationSource: Utilities.CancellationSource) {
        ...
        private _syncBookmarks(db, options) {
        ...
        private _syncBookmarkPendingAdds(db) {
        ...
        private _syncBookmarksForFolder(db, dbIdOfFolderToSync) {
            var b = this._bookmarks;
            var folderId;
            var pendingEdits;
        ...
        public sync(options: ISyncOptions) {
